...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        contentView.productId = 4
        
        /*  contentView.productName = "Sneakers g45"
         contentView.items = [
         ProductViewController.Item(mainImageName: "p1_0",
         nestedImagesNames: ["p1_1","p1_2","p1_3"], title: "Product 1" ),
         ProductViewController.Item(mainImageName:"p2_0", nestedImagesNames: ["p2_1", "p2_2", "p2_3"], title: "Product 2" )
